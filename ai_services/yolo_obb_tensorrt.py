...
Provides YOLOOBBTensorRT class for object detection with oriented bounding boxes.
Used for product and label detection in product verification.
"""
...
# Remove test code - this module only exports YOLOOBBTensorRT class
