...
class RecipeRepository:
    ...
    async def create(self, recipe: RecipeCreate, user_id: str) -> RecipeInDB:
        ...
        for f in ('ml_project_id', 'ml_model_id', 'ocr_model_type', 'ocr_project_id', 'ocr_model_id', 'defect_model', 'classifier_backend', 'cv_method', 'product_detection_method', 'product_box_wall_type'):
    ...
    async def update(self, recipe_id: str, recipe_update: RecipeUpdate, user_id: str) -> Optional[RecipeInDB]:
        ...
        NULLABLE_STR_FIELDS = ('ml_project_id', 'ml_model_id', 'ocr_model_type', 'ocr_project_id', 'ocr_model_id', 'defect_model', 'classifier_backend', 'cv_method', 'product_detection_method', 'product_box_wall_type')
