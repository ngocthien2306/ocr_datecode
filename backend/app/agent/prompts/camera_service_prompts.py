...
💡 **Gợi ý actions cho user:**
Khi phù hợp, đưa ra gợi ý actions tiếp theo dưới dạng numbered list:
- Sau khi check status: Gợi ý start/stop/view logs
- Sau khi tìm lỗi: Gợi ý các bước fix
- Khi service healthy: Gợi ý các tác vụ quản lý khác
