  ...
  const loadReceipts = async () => {
    try {
      ...
      const transformedReceipts = data.map(recipe => ({
        ...
        allow_late_reject: recipe.allow_late_reject === true,
        normal_pulse_ms: recipe.normal_pulse_ms ?? 250.0,
        // Sensor-based reject mode + PLC handshake config — surface so the
        // edit modal keeps user-selected values across open/close cycles.
        reject_mode: recipe.reject_mode || 'time_based',
        plc_verdict_register: recipe.plc_verdict_register ?? 0,
        plc_verdict_prefix: recipe.plc_verdict_prefix || 'D',
        plc_ready_coil: recipe.plc_ready_coil ?? 0,
        plc_ready_prefix: recipe.plc_ready_prefix || 'M',
        plc_ack_coil: recipe.plc_ack_coil ?? 1,
        plc_ack_prefix: recipe.plc_ack_prefix || 'M',
        plc_pulse_register: recipe.plc_pulse_register ?? 10,
        plc_pulse_prefix: recipe.plc_pulse_prefix || 'D',
        plc_ack_timeout_ms: recipe.plc_ack_timeout_ms ?? 200,
        ...
        ocr_project_id: recipe.ocr_project_id || '',
        ocr_model_id: recipe.ocr_model_id || '',
        ...
        cv_method: recipe.cv_method || 'v4',
        template_bank_enabled: recipe.template_bank_enabled ?? false,
        template_bank_size: recipe.template_bank_size ?? 10,
        char_denoise_enabled: recipe.char_denoise_enabled ?? false,
        product_detection_method: recipe.product_detection_method || 'yolo_obb',
        product_box_wall_type: recipe.product_box_wall_type || 'outer',
        save_pass_images: recipe.save_pass_images ?? true,
        cap_rotation_method: recipe.cap_rotation_method || 'yolo_obb',
        cap_crop_method: recipe.cap_crop_method || 'none',
        crop_match_method: recipe.crop_match_method || 'superpoint',
        dual_rotation_check: !!recipe.dual_rotation_check,
  ...
  const handleCloneReceipt = async (receipt: Receipt) => {
    try {
      ...
      const clonedReceipt: Receipt = {
        ...
        allow_late_reject: clonedRecipe.allow_late_reject === true,
        normal_pulse_ms: clonedRecipe.normal_pulse_ms ?? 250.0,
        // Sensor-based reject mode + PLC handshake config — preserve through clone.
        reject_mode: clonedRecipe.reject_mode || 'time_based',
        plc_verdict_register: clonedRecipe.plc_verdict_register ?? 0,
        plc_verdict_prefix: clonedRecipe.plc_verdict_prefix || 'D',
        plc_ready_coil: clonedRecipe.plc_ready_coil ?? 0,
        plc_ready_prefix: clonedRecipe.plc_ready_prefix || 'M',
        plc_ack_coil: clonedRecipe.plc_ack_coil ?? 1,
        plc_ack_prefix: clonedRecipe.plc_ack_prefix || 'M',
        plc_pulse_register: clonedRecipe.plc_pulse_register ?? 10,
        plc_pulse_prefix: clonedRecipe.plc_pulse_prefix || 'D',
        plc_ack_timeout_ms: clonedRecipe.plc_ack_timeout_ms ?? 200,
        ...
        ocr_project_id: clonedRecipe.ocr_project_id || '',
        ocr_model_id: clonedRecipe.ocr_model_id || '',
        ...
        cv_method: clonedRecipe.cv_method || 'v4',
        template_bank_enabled: clonedRecipe.template_bank_enabled ?? false,
        template_bank_size: clonedRecipe.template_bank_size ?? 10,
        char_denoise_enabled: clonedRecipe.char_denoise_enabled ?? false,
        product_detection_method: clonedRecipe.product_detection_method || 'yolo_obb',
        product_box_wall_type: clonedRecipe.product_box_wall_type || 'outer',
        save_pass_images: clonedRecipe.save_pass_images ?? true,
        cap_rotation_method: clonedRecipe.cap_rotation_method || 'yolo_obb',
        cap_crop_method: clonedRecipe.cap_crop_method || 'none',
        crop_match_method: clonedRecipe.crop_match_method || 'superpoint',
        dual_rotation_check: !!clonedRecipe.dual_rotation_check,
