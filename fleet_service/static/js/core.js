...
export const I18N = {
  en: {
    ...
    fleetAvg: 'fleet average', weighted: 'frames, sample-weighted',
    thinSample: 'thin sample',
    openStation: 'Line Station ↗',
    openStationHint: "Opens this machine's own screen at :8100/station",
    close: 'Close',
  ...
  vi: {
    ...
    fleetAvg: 'trung bình đội hình', weighted: 'frame, trọng số theo mẫu',
    thinSample: 'mẫu mỏng',
    openStation: 'Màn hình máy ↗',
    openStationHint: 'Mở màn hình của chính máy này tại :8100/station',
    close: 'Đóng',
