...
export default function RecipeViewModal({ isOpen, onClose, recipe, onEdit }) {
          ...
          <div className="info-section">
            ...
            <div className="info-grid">
              ...
              <div className="info-item">
                ...
                <div className="info-value">{recipe.cameraSettings?.delay_trigger} ms</div>
              </div>
              <div className="info-item">
                <label>Gain</label>
              ...
              <div className="info-item">
                ...
                <div className="info-value">{recipe.cameraSettings?.brightness || 'N/A'}</div>
              </div>
              <div className="info-item">
                <label>Contrast</label>
                <div className="info-value">{recipe.cameraSettings?.contrast || 'N/A'}</div>
              </div>
            </div>
          </div>
          ...
          <div className="info-section">
            ...
            <div className="info-grid">
              ...
              <div className="info-item">
                ...
                <div className="info-value">
                  {recipe.modelThresholds?.recognition_threshold ? 
                    `${(recipe.modelThresholds.recognition_threshold * 100).toFixed(1)}%` : 'N/A'}
                </div>
              </div>
              <div className="info-item">
                <label>Min Text Size</label>
                <div className="info-value">
                  {recipe.modelThresholds?.min_text_size ? 
                    `${recipe.modelThresholds.min_text_size} px` : 'N/A'}
                </div>
              </div>
              <div className="info-item">
                <label>Max Text Size</label>
                <div className="info-value">
                  {recipe.modelThresholds?.max_text_size ? 
                    `${recipe.modelThresholds.max_text_size} px` : 'N/A'}
                </div>
              </div>
            </div>
          </div>
